  ...
  test("POST /policies", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        policyExpiryDate: CREATE_RESULT.policyExpiryDate.toISOString(),
      ...
      .expect([
        {
          ...
          policyExpiryDate: FIND_MANY_RESULT[0].policyExpiryDate.toISOString(),
  ...
  test("GET /policies/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        policyExpiryDate: FIND_ONE_RESULT.policyExpiryDate.toISOString(),
